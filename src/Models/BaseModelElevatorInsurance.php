 ...
 */
class BaseModelElevatorInsurance implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\ElevatorInsurance $message public property
     */
    public $message;
     ...
     * @param ElevatorInsurance $message   Initialization value for $this->message
