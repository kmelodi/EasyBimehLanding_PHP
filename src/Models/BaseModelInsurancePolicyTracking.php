 ...
 */
class BaseModelInsurancePolicyTracking implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\InsurancePolicyTracking $message public property
     */
    public $message;
     ...
     * @param InsurancePolicyTracking $message   Initialization value for $this->message
