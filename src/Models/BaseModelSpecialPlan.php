 ...
 */
class BaseModelSpecialPlan implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\SpecialPlan[] $message public property
     */
    public $message;
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\ExtraDataBaseModelSpecialPlan $extraData public property
     */
    public $extraData;
     ...
     * @param ExtraDataBaseModelSpecialPlan $extraData Initialization value for $this->extraData
