 ...
 */
class BaseModelTravelInsurance implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\TravelInsurance $message public property
     */
    public $message;
     ...
     * @param TravelInsurance $message   Initialization value for $this->message
