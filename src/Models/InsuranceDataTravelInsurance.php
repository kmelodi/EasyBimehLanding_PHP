 ...
 */
class InsuranceDataTravelInsurance implements JsonSerializable
{
    /**
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\TravelInsurancePolicyExtendView $travelInsurancePolicyExtendView public property
     */
    public $travelInsurancePolicyExtendView;

    /**
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\TravelInsurancePolicyFilter $travelInsurancePolicyFilter public property
     */
    public $travelInsurancePolicyFilter;
     ...
     * @param TravelInsurancePolicyExtendView $travelInsurancePolicyExtendView       Initialization value for $this-
     *                                                                                 >travelInsurancePolicyExtendView
     * @param TravelInsurancePolicyFilter     $travelInsurancePolicyFilter           Initialization value for $this-
     ...
     *                                                                                 >selectedInsurancePolicyHasBeenCh
     *                                                                                 anged
    ...
    {
        if (21 == func_num_args()) {
            $this->travelInsurancePolicyExtendView       = func_get_arg(0);
            $this->travelInsurancePolicyFilter           = func_get_arg(1);
    ...
    {
        $json = array();
        $json['travelInsurancePolicyExtendView']       = $this->travelInsurancePolicyExtendView;
        $json['travelInsurancePolicyFilter']           = $this->travelInsurancePolicyFilter;
        $json['id']                                    = $this->id;
