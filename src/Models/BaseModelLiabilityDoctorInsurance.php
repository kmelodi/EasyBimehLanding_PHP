 ...
 */
class BaseModelLiabilityDoctorInsurance implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\LiabilityDoctorInsurance $message public property
     */
    public $message;
     ...
     * @param LiabilityDoctorInsurance $message   Initialization value for $this->message
