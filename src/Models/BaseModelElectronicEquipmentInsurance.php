 ...
 */
class BaseModelElectronicEquipmentInsurance implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\ElectronicEquipmentInsurance $message public property
     */
    public $message;
     ...
     * @param ElectronicEquipmentInsurance $message   Initialization value for $this->message
