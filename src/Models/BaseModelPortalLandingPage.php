 ...
 */
class BaseModelPortalLandingPage implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\PortalLandingPage $message public property
     */
    public $message;
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\ExtraDataBaseModelPortalLandingPage $extraData public property
     */
    public $extraData;
     ...
     * @param PortalLandingPage                   $message   Initialization value for $this->message
     * @param ExtraDataBaseModelPortalLandingPage $extraData Initialization value for $this->extraData
