 ...
 */
class BaseModelEarthquake implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\Earthquake $message public property
     */
    public $message;
     ...
     * @param Earthquake $message   Initialization value for $this->message
