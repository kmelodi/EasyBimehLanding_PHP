 ...
 */
class BaseModelPortalLandingContactAbout implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\PortalLandingContactAbout $message public property
     */
    public $message;
     ...
     * @param PortalLandingContactAbout $message   Initialization value for $this->message
