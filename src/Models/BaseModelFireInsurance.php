 ...
 */
class BaseModelFireInsurance implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\FireInsurance $message public property
     */
    public $message;
     ...
     * @param FireInsurance $message   Initialization value for $this->message
