...
class Status200 implements JsonSerializable
{
     ...
     * @todo Write general description for this property
     * @required
     * @var \EasyBimehLandingLib\Models\GetAccessTokenUserInfo $message public property
     */
    public $message;
     ...
     * @param GetAccessTokenUserInfo $message   Initialization value for $this->message
