...
class MainController extends BaseController
{
     ...
     */
    public function getPortalLandingPage(
        $id,
        $xApiKey
    ) {

        //prepare query string for API call
        $_queryBuilder = '/InsuranceCentre/PortalLandingPage';
        ...
        return $mapper->mapClass($response->body, 'EasyBimehLandingLib\\Models\\BaseModelPortalLandingPage');
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getInsuranceCentrePolicyTypes(
        $subDomain,
        $xApiKey
    ) {

        //prepare query string for API call
        $_queryBuilder = '/ComboData/InsuranceCentrePolicyTypes';
        ...
        return $mapper->mapClass($response->body, 'EasyBimehLandingLib\\Models\\BaseModelInsuranceCentrePolicyTypes');
    }
}
