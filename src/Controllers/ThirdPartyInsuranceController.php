 ...
 */
class ThirdPartyInsuranceController extends BaseController
{
    /**
     * @var ThirdPartyInsuranceController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return ThirdPartyInsuranceController The *Singleton* instance.
     */
     ...
     *
     * @param integer $carTypeGroup شناسه ی گروه خودرو
    ...
    public function getRiskLevel(
        ...
        //prepare query string for API call
        $_queryBuilder = '/ComboData/RiskLevel';
        ...
        return $mapper->mapClass($response->body, 'EasyBimehLandingLib\\Models\\RiskLevel');
    }
     ...
     *
     * @param integer $carTypeId شناسه ی نوع خودرو
     * @param string  $xApiKey   کلید اختصاصی ارتباط با سرور
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getCarUses(
        $carTypeId,
        $xApiKey
    ) {

        //prepare query string for API call
        $_queryBuilder = '/ComboData/CarUses';
        ...
        return $mapper->mapClass($response->body, 'EasyBimehLandingLib\\Models\\CarUses');
    }
     ...
     * @param integer $insurancePolicyType شناسه ی نوع بیمه
     * @param string  $xApiKey             کلید اختصاصی ارتباط با سرور
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
