 ...
 */
class InsurancePolicyPlanController extends BaseController
{
    /**
     * @var InsurancePolicyPlanController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return InsurancePolicyPlanController The *Singleton* instance.
     */
     ...
     */
    public function getSpecialPlan(
        $subDomain,
        $xApiKey
    ) {

        //prepare query string for API call
        $_queryBuilder = '/InsurancePolicyPlan/SpecialPlan';
        ...
        return $mapper->mapClass($response->body, 'EasyBimehLandingLib\\Models\\BaseModelSpecialPlan');
    }
}
