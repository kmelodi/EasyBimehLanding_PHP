...
use EasyBimehLandingLib\Http\HttpCallBack;
...
class HttpCallBackCatcher extends HttpCallBack
{
    /**
     * Http request
     * @var EasyBimehLandingLib\Http\HttpRequest
     */
    private $request;

    /**
     * Http Response
     * @var EasyBimehLandingLib\Http\HttpResponse
     */
    private $response;
     ...
     * @return EasyBimehLandingLib\Http\HttpRequest
     */
     ...
     * @return EasyBimehLandingLib\Http\HttpResponse
     */
